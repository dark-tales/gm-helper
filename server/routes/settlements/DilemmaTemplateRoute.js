...
// import models
const DilemmaTemplate = require("../../models/settlements/dilemmaTemplate")
...
router.get('/random/:strainLevel', async (req, res) => {
    try {
        ...
        const templates = await DilemmaTemplate.find({ strainLevel });
...
router.delete("/:id", async (req, res) => {
    const {id} = req.params
    await DilemmaTemplate.findByIdAndDelete(id)
